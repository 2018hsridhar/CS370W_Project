...
//	const char* offsetGenScan1File = TUTORIAL_SHARED_PATH "/planexy.off";
 //   const char* offsetGenScan2File = TUTORIAL_SHARED_PATH "/planexy2.off";
//	const char* offsetGenScan1File= TUTORIAL_SHARED_PATH "/camelhead.off";
 //   const char* offsetGenScan2File= TUTORIAL_SHARED_PATH "/camelhead2.off";
	const char* offsetGenScan1File= TUTORIAL_SHARED_PATH "/2triangles.off";
    const char* offsetGenScan2File= TUTORIAL_SHARED_PATH "/camelhead2.off";
